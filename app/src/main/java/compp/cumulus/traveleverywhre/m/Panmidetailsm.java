...
import compp.cumulus.traveleverywhre.net.PanmidetailsApiServer;
            ...
            data.subscribeOn(Schedulers.io())  //被观察者在子线程
                    ...
                    .subscribe(new Observer<String>() {
                        ...
                        public void onNext(String value) {
                            Logger.logD("wwwwwwwwwwwwwwwwwww","sdf"+value);
